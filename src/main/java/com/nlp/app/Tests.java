...
//		ver.add(ApiHolder.getInstance().factory.createAnswer("because people need to help" ,40, "TEACHER").build());
//
//		badToCheck.add(ApiHolder.getInstance().factory.createAnswer("because people need to help", 0, "STUDENT"));// close meaning2
//
//		double passed = 0;
//		double tests = 0;
//
//		for (Answer student_ans: goodToCheck) {
//			student_ans.checkAnswer(ver, ver);
//			tests++;
//			if (student_ans.getGrade()==-2) return; //error
//			if (grade>=50) {
//				passed++;
